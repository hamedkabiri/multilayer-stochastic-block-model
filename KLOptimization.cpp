...
const int TrueCommsAvailable = 1; // 1 reads them in and includes in printout 
...
void GetTheNetworkEdges()
{
     ...
     ifstream InputFile;
     ifstream InputFile2;
     string fileName = "polBlogsSymmLargestFEdges.txt";
     ...
     sscanf(buffer, "%d %d %d", &entry1, &entry2, &ignore);
